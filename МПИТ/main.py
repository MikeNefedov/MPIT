...
class MyApp(App):
	...
	def build(self):
		...
		self.addit_body_lbl = Label(text='Укажите телосложение(худой, мускулистый, полноватый)', bold=True, pos_hint ={'center_x':.5}, size_hint =(.7, .4), pos =(214.0, 395.0), opacity=0)
		...
		self.addit_patience_lbl = Label(text='Укажите уровень терпения (от 1 до 5):', bold=True, pos_hint ={'center_x':.5}, size_hint =(.7, .4), pos =(214.0, 335.0), opacity=0)
		...
		#front----------------------------------------------------------------------------------------------------------------------------------------
		buttons_layout.add_widget(self.addit_height_lbl)
		buttons_layout.add_widget(self.addit_height)
        buttons_layout.add_widget(self.addit_body_lbl)
		buttons_layout.add_widget(self.addit_body_type)
        buttons_layout.add_widget(self.addit_patien_lbl)
		buttons_layout.add_widget(self.addit_patience)
